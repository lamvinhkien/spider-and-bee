import TrinhSatLocation from "./TrinhSatLocation";
import TrinhSatLock from "./TrinhSatLock";
import EndGame from "./EndGame";
import OngIndex from "./OngIndex"
import NhenIndex from "./App"
import React, { useState } from 'react';

function TrinhSatIndex({ onBack }) {
  ...
  if (selectedCharacter === 'nhen-index') {
    return <NhenIndex onBack={() => handleSelectCharacter(null)} />;
  }

  if (selectedCharacter === 'ong-index') {
    return <OngIndex onBack={() => handleSelectCharacter(null)} />;
  }

  if (selectedCharacter === 'trinhsat-location') {
    return <TrinhSatLocation onBack={() => handleSelectCharacter(null)} />;
  }

  if (selectedCharacter === 'trinhsat-lock') {
    return <TrinhSatLock onBack={() => handleSelectCharacter(null)} />;
  }
  ...
  const backgroundStyle = {
    background: 'linear-gradient(180deg, #975F1C 0%, #F08F1D 50%, #251C1D 100%)',
    minHeight: '100vh',
      ...
      <main className="container-fluid flex-grow-1 d-flex flex-column justify-content-center align-items-center p-4">
        ...
        <div className="text-center mb-5 mt-5">
          ...
          <h2 className="text-white fs-4 fw-light mt-3">
            Bạn là Ong Trinh Sát <img src="/trinhsat-icon.png" width='7%' alt="trinhsat-icon" />
          </h2>
        </div>
        ...
        <div className="d-flex justify-content-center w-100 mb-5">
          ...
          <div className="dropdown">
            ...
            <ul className="dropdown-menu" aria-labelledby="vaiTroDropdown">
              ...
              <li onClick={() => setSelectedCharacter('ong-index')}><span className="dropdown-item">Ong</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="row justify-content-around text-center w-100 mb-2">
          ...
          <div className="col-4">
            <i className="fa-solid fa-skull-crossbones text-white fs-1"></i>
          </div>
          <div className="col-4">
        ...
        <div className="row justify-content-center w-100 g-4">
          <div className="col-4 d-flex justify-content-center">
            <div style={imagePlaceholder} onClick={() => setSelectedCharacter('trinhsat-location')}>
              <img
                src="/location.png"
                alt="Vị trí"
          ...
          <div className="col-4 d-flex justify-content-center">
            <div style={imagePlaceholder} onClick={() => setSelectedCharacter('trinhsat-lock')}>
              <img
                src="/trinh-sat.png"
                alt="trinh sat"
                style={{ width: '100%', height: 'auto', objectFit: 'contain' }}
