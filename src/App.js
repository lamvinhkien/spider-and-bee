import NhenLocation from "./NhenLocation";
import NhenLock from "./NhenLock";
...
function App({ onBack }) {
  ...
  if (selectedCharacter === 'nhen-location') {
    return <NhenLocation onBack={() => handleSelectCharacter(null)} />;
  }

  if (selectedCharacter === 'nhen-lock') {
    return <NhenLock onBack={() => handleSelectCharacter(null)} />;
  }
    ...
    <div className="d-flex flex-column" style={backgroundStyle}>
      <main className="container-fluid flex-grow-1 d-flex flex-column justify-content-center align-items-center p-4">
        ...
        <div className="row justify-content-around text-center w-100 mb-2">
          ...
          <div className="col-4">
            <i className="fa-solid fa-lock text-white fs-1"></i>
          </div>
          <div className="col-4">
        ...
        <div className="row justify-content-center w-100 g-4">
          <div className="col-4 d-flex justify-content-center">
            <div style={imagePlaceholder} onClick={() => setSelectedCharacter('nhen-location')}>
              <img
                src="/location.png"
                alt="Vị trí"
          ...
          <div className="col-4 d-flex justify-content-center">
            <div style={imagePlaceholder} onClick={() => setSelectedCharacter('nhen-lock')}>
              <img
                src="/luoi-nhen.png"
                alt="Lưới nhện"
                style={{ width: '100%', height: 'auto', objectFit: 'contain' }}
